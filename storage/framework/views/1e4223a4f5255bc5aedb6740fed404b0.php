                ...
                <div class="content-box">
                    ...
                    <div class="mb-12">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                            ...
                            ]; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $label => $icon): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <div class="data-grid-item p-6 flex items-start gap-5">
                                <div class="w-12 h-12 bg-brand-blue flex items-center justify-center rounded-xl shrink-0 shadow-lg">
                                    <i class="fas <?php echo e($icon); ?> text-brand-green"></i>
                                </div>
                                <div>
                                    <h5 class="text-brand-blue font-black text-[11px] uppercase tracking-wider mb-1"><?php echo e($label); ?></h5>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol12_3/infinityfree.com/if0_40168482/selogisticscompany.66ghz.com/htdocs/resources/views/pages/privacy.blade.php ENDPATH**/ ?>