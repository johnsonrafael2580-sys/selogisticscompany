...
<body class="min-h-screen flex items-center justify-center p-4 sm:p-6 relative overflow-x-hidden">
    ...
    <div class="w-full max-w-md glass-card p-6 sm:p-8 rounded-[2rem] shadow-2xl relative z-10 transition-all">
        ...
        <!-- Back Navigation -->
        <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center text-gray-400 hover:text-green-400 text-[10px] font-bold mb-6 transition group">
        ...
        <div class="mt-8 text-center border-t border-white/5 pt-6">
            <p class="text-gray-400 text-xs">
                ...
                <a href="<?php echo e(route('register')); ?>" class="text-green-500 font-black hover:text-white transition ml-1 uppercase">Get Started</a>
            </p>
        </div>
    </div>
...
</html><?php /**PATH /home/vol12_3/infinityfree.com/if0_40168482/selogisticscompany.66ghz.com/htdocs/resources/views/auth/login.blade.php ENDPATH**/ ?>