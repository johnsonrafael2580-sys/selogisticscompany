        ...
        <div class="max-w-4xl mx-auto">
            ...
            <?php if(session('success')): ?>
                <div class="mb-6 p-4 bg-emerald-50 border-l-4 border-emerald-500 rounded-r-xl flex items-center shadow-sm animate-bounce">
                    ...
                    <span class="text-emerald-800 font-bold text-sm"><?php echo e(session('success')); ?></span>
                </div>
            <?php endif; ?>
            ...
            <div class="mt-8 text-center">
                <p class="text-slate-400 text-[10px] font-black uppercase tracking-[0.3em]">
                    &copy; <?php echo e(date('Y')); ?> SE Logistics Company Ltd • Customer CRM Module
                </p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol12_3/infinityfree.com/if0_40168482/selogisticscompany.66ghz.com/htdocs/resources/views/admin/customers/create.blade.php ENDPATH**/ ?>