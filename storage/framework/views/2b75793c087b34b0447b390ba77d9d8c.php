                ...
                <div class="lg:col-span-5 space-y-8" data-aos="fade-left">
                    ...
                    <div class="bg-gray-50 border-2 border-dashed border-gray-200 p-10 rounded-2xl text-center">
                        ...
                        <div class="relative z-30">
                           <a href="<?php echo e(route('dashboard')); ?>" class="btn-quote inline-block">
                            Get a Quote Now
                           </a>
                           </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol12_3/infinityfree.com/if0_40168482/selogisticscompany.66ghz.com/htdocs/resources/views/pages/customs.blade.php ENDPATH**/ ?>