            ...
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        ...
                        <p class="text-blue-100/70 text-sm font-medium">Updating information for: <span class="text-white font-bold">{{ $customer->name }}</span></p>
                    </div>
                </div>
        ...
        <div class="max-w-4xl mx-auto">
                            ...
                            <div class="md:col-span-2">
                                ...
                                <div class="relative">
                                    ...
                                    <textarea name="address" rows="3"
                                        class="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold text-[#003366] form-input-focus transition-all" 
                                        placeholder="Update address...">{{ old('address', $customer->address) }}</textarea>
                                </div>
                            </div>
                        </div>
            ...
            <div class="mt-8 text-center">
                <p class="text-slate-400 text-[10px] font-black uppercase tracking-[0.3em]">
                    &copy; {{ date('Y') }} SE Logistics Company Ltd • Internal Management Portal
                </p>
            </div>
        </div>
    </div>
