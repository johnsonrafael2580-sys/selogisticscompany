...
<body class="min-h-screen flex items-center justify-center p-4 relative overflow-hidden">
    <div class="w-full max-w-md bg-white/10 backdrop-blur-md border border-white/20 p-6 rounded-3xl shadow-2xl relative z-10">
        <a href="<?php echo e(route('home')); ?>" class="inline-flex items-center text-gray-400 hover:text-green-500 text-[10px] font-bold mb-4">
        ...
        <form action="<?php echo e(route('register')); ?>" method="POST" class="grid grid-cols-1 gap-3">
            <?php echo csrf_field(); ?>
            <div>
        ...
        <div class="mt-6 text-center border-t border-white/10 pt-4">
            <p class="text-gray-400 text-[11px]">Already registered? <a href="<?php echo e(route('login')); ?>" class="text-green-500 font-bold hover:underline">SIGN IN</a></p>
        </div>
    </div>
</body>
</html><?php /**PATH /home/vol12_3/infinityfree.com/if0_40168482/selogisticscompany.66ghz.com/htdocs/resources/views/auth/register.blade.php ENDPATH**/ ?>