...
<div class="relative h-[400px] md:h-[500px] flex items-center justify-center overflow-hidden">
    <div class="absolute inset-0 z-0">
        ...
        <img src="<?php echo e(asset($company->hero_image ?? 'public/assets/images/picha14.png')); ?>" 
    ...
    <div class="relative z-10 text-center px-4 max-w-4xl">
        <span class="text-custom-green font-semibold tracking-widest uppercase text-sm mb-4 block">
            <?php echo e($company->tagline ?? 'Reliable Clearing & Forwarding'); ?>

        </span>
        <h1 class="text-white text-4xl md:text-6xl font-extrabold leading-tight mb-6">
            <?php echo e($company->name ?? 'SE Global Logistics'); ?> <br> 
            <span class="text-custom-green"><?php echo e($page_title ?? 'Company Overview'); ?></span>
        </h1>
    ...
    <div class="max-w-7xl mx-auto flex flex-col lg:flex-row gap-20 items-center">
        ...
        <div class="lg:w-1/2">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div class="stat-card bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
                    ...
                    <p class="text-sm text-gray-500 leading-snug"><?php echo e($company->mission); ?></p>
                </div>
                ...
                <div class="stat-card bg-white p-6 rounded-lg border border-gray-100 shadow-sm">
                    ...
                    <p class="text-sm text-gray-500 leading-snug"><?php echo e($company->vision); ?></p>
                </div>
            </div>
        </div>
        ...
        <div class="lg:w-1/2 relative">
            <div class="relative overflow-hidden rounded-2xl shadow-xl">
                <img src="<?php echo e(asset($about->image ?? 'https://images.unsplash.com/photo-1586528116311-ad8dd3c8310d')); ?>" 
                ...
                <ul class="space-y-4">
                    <?php $__empty_1 = true; $__currentLoopData = $values; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $value): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                        <li class="flex items-center text-gray-700 font-semibold text-sm">
                            ...
                            <?php echo e(strtoupper($value->name)); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol12_3/infinityfree.com/if0_40168482/selogisticscompany.66ghz.com/htdocs/resources/views/pages/overview.blade.php ENDPATH**/ ?>