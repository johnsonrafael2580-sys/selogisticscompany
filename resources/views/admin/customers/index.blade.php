        ...
        <div class="container mx-auto px-6">
            <div class="flex flex-col md:flex-row justify-between items-center gap-6">
                ...
                <div class="flex items-center space-x-4">
                    ...
                    <a href="{{ route('admin.dashboard') }}" class="hidden md:flex items-center space-x-2 bg-white/10 hover:bg-white/20 px-5 py-3 rounded-xl transition-all border border-white/20 font-bold text-xs uppercase tracking-widest">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path></svg>
                        <span>Dashboard</span>
                    </a>

                    <!-- ADD NEW CUSTOMER BUTTON -->
                    <a href="{{ route('admin.customers.create') }}" class="group relative inline-flex items-center justify-center">
    ...
    <div class="container mx-auto px-6 -mt-16">
                        ...
                        <tr class="table-row-hover group">
                            ...
                            <td class="px-8 py-6">
                                <div class="flex items-center">
                                    ...
                                    <div class="ml-4">
                                        <div class="text-sm font-black text-[#003366]">{{ $customer->name }}</div>
                                        <div class="text-[10px] text-[#22C55E] font-bold tracking-widest uppercase">ID: #{{ $customer->id }}</div>
                                    </div>
                                </div>
                            </td>
                            ...
                            <td class="px-8 py-6 text-center">
                                <span class="inline-flex items-center px-4 py-1.5 rounded-full text-[10px] font-black bg-emerald-50 text-[#22C55E] uppercase tracking-wider border border-emerald-100">
                                    ...
                                    {{ $customer->shipments_count ?? 0 }} Items
                                </span>
                            </td>
                            ...
                            <td class="px-8 py-6">
                                <div class="flex items-start max-w-[200px]">
                                    ...
                                    <p class="text-xs text-slate-500 leading-relaxed italic">{{ Str::limit($customer->address, 40) }}</p>
                                </div>
                            </td>
                            ...
                            <td class="px-8 py-6 text-right">
                                <div class="flex justify-end gap-2">
                                    <a href="{{ route('admin.customers.edit', $customer->id) }}" class="p-2.5 bg-blue-50 text-[#003366] rounded-xl hover:bg-[#003366] hover:text-white transition-all shadow-sm">
                                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                    </a>
                                    <form action="{{ route('admin.customers.destroy', $customer->id) }}" method="POST" onsubmit="return confirm('ARE YOU SURE? This will permanently delete this client.');" class="inline">
                                        @csrf @method('DELETE')
        ...
        <div class="mt-8 flex flex-col md:flex-row justify-between items-center gap-4 px-4">
            <p class="text-slate-500 text-xs font-bold uppercase tracking-widest">
                Showing <span class="text-[#003366]">{{ $customers->count() }}</span> Registered Clients
            </p>
