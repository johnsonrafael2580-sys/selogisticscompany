        ...
        <div class="container mx-auto px-6">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    ...
                    <div>
                        <h2 class="text-3xl font-black tracking-tight uppercase">Edit Customer</h2>
                        <p class="text-blue-100/70 text-sm font-medium">Updating information for: <span class="text-white font-bold"><?php echo e($customer->name); ?></span></p>
                    </div>
                </div>
                
                <a href="<?php echo e(route('admin.customers.index')); ?>" class="hidden md:flex items-center space-x-2 bg-white/10 hover:bg-white/20 px-5 py-2.5 rounded-xl transition-all border border-white/20 font-bold text-xs uppercase tracking-widest">
        ...
        <div class="max-w-4xl mx-auto">
                ...
                <div class="p-8 md:p-12">
                    <form action="<?php echo e(route('admin.customers.update', $customer->id)); ?>" method="POST">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <!-- Address -->
                            <div class="md:col-span-2">
                                <label class="block text-[11px] font-black text-slate-400 uppercase tracking-[0.2em] mb-2 ml-1">Physical Address</label>
                                <div class="relative">
                                    <span class="absolute top-4 left-0 pl-4 flex text-slate-400">
                                        <svg class="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 11a3 3 0 11-6 0 3 3 0 016 0z"></path></svg>
                                    </span>
                                    <textarea name="address" rows="3"
                                        class="w-full pl-12 pr-4 py-4 bg-slate-50 border border-slate-100 rounded-2xl text-sm font-bold text-[#003366] form-input-focus transition-all" 
                                        placeholder="Update address..."><?php echo e(old('address', $customer->address)); ?></textarea>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="mt-12 pt-8 border-t border-slate-50 flex flex-col md:flex-row justify-between items-center gap-4">
                            <a href="<?php echo e(route('admin.customers.index')); ?>" class="text-slate-400 hover:text-slate-600 font-bold text-xs uppercase tracking-widest transition-colors">
                                Cancel Changes
                            </a>
            ...
            <div class="mt-8 text-center">
                <p class="text-slate-400 text-[10px] font-black uppercase tracking-[0.3em]">
                    &copy; <?php echo e(date('Y')); ?> SE Logistics Company Ltd • Internal Management Portal
                </p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH /home/vol12_3/infinityfree.com/if0_40168482/selogisticscompany.66ghz.com/htdocs/resources/views/admin/customers/edit.blade.php ENDPATH**/ ?>