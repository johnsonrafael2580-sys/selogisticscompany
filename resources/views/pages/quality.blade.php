    ...
    <section class="hero-quality-redesign">
        ...
        <div class="hero-container">
            <div class="fade-in-up">
                ...
                <div class="mt-8">
                   <a href="{{ route('compliance.index') }}" class="btn-logistics">
        ...
        <div class="max-w-7xl mx-auto">
            ...
            <div class="mt-24 border-t-2 border-soft-blue pt-12">
                <div class="flex flex-wrap justify-center gap-6 md:gap-12">
                    @foreach(['Market Leader', '100% On-Time', 'Ethical Standards', 'Global Innovation'] as $tag)
                    <div class="flex items-center space-x-3">
                        <i class="fas fa-star text-brand-green text-xs"></i>
                        <span class="text-xs font-black uppercase tracking-widest text-brand-blue">{{ $tag }}</span>
                    </div>
                    @endforeach
                </div>
            </div>
